                                ...
                                <div class="vd_content-section clearfix">
                                    <div class="vd_login-page">
                                        <div class="heading clearfix">
                                            <div class="logo">
                                                <h2 class="mgbt-xs-5"><b>Ojeg App</b></h2><br/>
                                            </div>
                                        ...
                                        <div class="panel widget">
                                            <div class="panel-body">
                                                ...
                                                <form class="form-horizontal" action="admin/login" method="post" role="form">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-md-12 text-center mgbt-xs-5">
                                                            <button class="btn vd_white width-100" style="background-color:#0F72AD" type="submit" >Login</button>
                                                        </div>
                                                        <!--                                                        <div class="col-md-12">
                                                                                                                    <div class="row">
